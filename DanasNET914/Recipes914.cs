...
{
    public class Recipes914
    {
        public static Dictionary<Scp914.Scp914KnobSetting, List<SCP914Recipe>> RecipeList { get; set; } = new Dictionary<Scp914.Scp914KnobSetting, List<SCP914Recipe>>
        {
