...
namespace DanasNET914
{
    public class SCP914RecipeNew
    {
        ...
        public SCP914RecipeNew(Scp914.Scp914KnobSetting setting, int initialChance, ItemType oldItem, Dictionary<ItemType, int> recipes)
        {
